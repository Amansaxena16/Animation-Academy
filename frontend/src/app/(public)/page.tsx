...
export default function HomePage() {
  return (
    <section className="mx-auto max-w-[1200px] px-4 py-12 md:px-6 md:py-24">
      ...
      <h1 className="type-display-xl text-ink mt-4 mb-0 max-w-3xl">
        Learn the tools. Build the work.
      </h1>
      <p className="type-body-lg text-ink-muted mt-5 mb-0 max-w-[540px]">
        An ISO 9001:2000 certified multimedia institute in Nehru Nagar, Kanpur —
        computer, accounting, design and animation courses taught on real
        machines, from typing to an eighteen-month multimedia diploma.
      </p>
      ...
      <p className="text-ink-muted mt-6 text-sm">
        <b className="text-ink">Monthly fees</b> from ₹700 · one-time
        registration ₹{SITE.registrationFee}
      </p>
    </section>
  );
}
