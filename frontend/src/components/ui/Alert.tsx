...
const TONES = {
  ...
  success: { box: "bg-success-soft", icon: "text-success-ink", Icon: CircleCheck },
  warning: { box: "bg-accent-soft", icon: "text-accent-ink", Icon: TriangleAlert },
...
export function Alert({ tone = "info", title, children, className }: AlertProps) {
  ...
  return (
    <div
      ...
      className={cn("flex items-start gap-3 rounded-md px-4 py-3.5 text-sm leading-[21px] text-ink", t.box, className)}
    >
