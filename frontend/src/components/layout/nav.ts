...
export const STUDENT_NAV: NavItem[] = [
  ...
  { label: "Certificates", href: "/student/certificates", icon: Award, mobile: true },
...
export const ADMIN_NAV: NavItem[] = [
  ...
  { label: "Enrollments", href: "/admin/enrollments", icon: ClipboardList, group: "Manage", mobile: true },
  ...
  { label: "Announcements", href: "/admin/announcements", icon: Megaphone, group: "Website" },
